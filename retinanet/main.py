...
def parse_args(args):
    ...
    pascal_parser.add_argument('train_imgs_dir', default="../dataset/train_imgs",
                               help='Path to dataset directory (ie. /tmp/VOCdevkit).')
    pascal_parser.add_argument('train_anns_dir', default="../dataset/train_anns",
                               help='Path to dataset directory (ie. /tmp/VOCdevkit).')
    pascal_parser.add_argument('valid_imgs_dir', default="../dataset/valid_imgs",
                               help='Path to dataset directory (ie. /tmp/VOCdevkit).')
    pascal_parser.add_argument('valid_anns_dir', default="../dataset/valid_anns",
                               help='Path to dataset directory (ie. /tmp/VOCdevkit).')
